...
@section[#:tag "a2-dupe-plus" #:style 'unnumbered]{Dupe+}
...
@subsection[#:tag-prefix "a2-" #:style 'unnumbered]{Primitives}
...
@subsection[#:tag-prefix "a2-" #:style 'unnumbered]{Conditional expressions}
...
@section[#:tag-prefix "a2-" #:style 'unnumbered]{Implementing Dupe+}
...
@section[#:tag-prefix "a2-" #:style 'unnumbered #:tag "parse"]{Parsing Dupe+}
...
expressions and an expression.  The two lists represent the clauses,
...
(list (Prim1 'not (Lit #t))) (list (Lit 3)) (Lit 5))], and}
...
@section[#:tag-prefix "a2-" #:style 'unnumbered]{Steps toward Dupe+}
...
@item{Update @tt{interpreter/interp-prim.rkt} and
@tt{interpreter/interp.rkt} to correctly interpret @racket[cond]
expressions and new primitives.}
...
@item{Update @tt{compiler/compile.rkt} and
@tt{compiler/compile-ops.rkt} to correctly compile these expressions
